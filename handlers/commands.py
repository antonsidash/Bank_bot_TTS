...
async def sleep_bot(message:types.Message,bot:Bot,id):
    ...
    if f:
        ...
        tts = gTTS(info_message, lang="ru")
        tts.save(r'vm/tts.mp3')
        voice_file = AudioSegment.from_mp3(r'vm/tts.mp3')
        voice_file.export(r'vm/tts.ogg', format="ogg")
        voice_file = types.FSInputFile(r'vm/tts.ogg')
        await bot.send_voice(message.chat.id, voice_file)
        os.remove(r'vm/tts.mp3')
        os.remove(r'vm/tts.ogg')
...
async def start(message:types.Message,state: FSMContext):
    ...
    #shutil.copy(r'C:\Program Files\FFmpeg\bin\ffmpeg.exe', r'C:\Users\Anton\Desktop\bank_helper_bot\ffmpeg.exe')
    if (not os.path.exists(r'vm/hello.mp3')):
        tts = gTTS('Здравствуйте! Задайте свой вопрос по поводу банковских услуг нейросети', lang="ru")
        tts.save(r'vm/hello.mp3')
    voice_file = types.FSInputFile(r'vm/hello.mp3')
    await bot.send_voice(message.chat.id, voice_file)
